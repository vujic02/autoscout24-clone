...
type BodyType = {
  id: string;
  label: string;
  imageSrc: string; // ti popunjavaš putanje
};

const BODY_TYPES: BodyType[] = [
  { id: "compact", label: "Compact", imageSrc: "/body-types/compact.webp" },
  { id: "suv", label: "SUV & Pick-up", imageSrc: "/body-types/suv.webp" },
  { id: "transporter", label: "Transporter", imageSrc: "/body-types/transport.webp" },
  ...
  { id: "station-wagon", label: "Station wagon", imageSrc: "/body-types/wagon.webp" },
  { id: "coupe", label: "Coupe", imageSrc: "/body-types/coupe.webp" },
];

interface BodyTypeSearchProps {
  onSelectBodyType?: (id: string) => void; // opcionalno, za kasnije
}

const BodyTypeSearch: React.FC<BodyTypeSearchProps> = ({ onSelectBodyType }) => {
  return (
