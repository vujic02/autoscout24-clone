...
const VehicleCard = (props: Props) => {
  return (
    <div className="relative flex flex-col">
      <div className="bg-[#eaeaea] flex justify-center items-center w-full h-48 rounded-t-md">
      ...
      <div className="border border-[#eaeaea] bg-white flex flex-col p-2">
        <h6 className="font-medium">Yamaha YZF-R6</h6>
        <h4 className="font-semibold mt-1">€ 1,500.-</h4>
